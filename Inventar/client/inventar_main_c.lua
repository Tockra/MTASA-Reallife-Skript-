...
local function onItemMouseLeave()
	...
	if(( (not lockItemUseState[aktuel] or not lockItemUseState[aktuel][tonumber(guiGetText(source))]) or getMouseState() == "down")) then
...
local function renderInventar()
		...
		dxDrawImage(x+20,y-48,48.0,48.0,"Inventar/images/portmonai.png",0.0,0.0,0.0,tocolor(255,255,255,255),true)
		...
		dxDrawImage(x+20 + 82,y-48,48.0,48.0,"Inventar/images/schluesselbund.png",0.0,0.0,0.0,tocolor(255,255,255,255),true)
		...
		dxDrawImage(x+20 + 82*2,y-48,48.0,48.0,"Inventar/images/rucksackIcon.png",0.0,0.0,0.0,tocolor(255,255,255,255),true)
		...
		dxDrawImage(x+20 + 82*3,y-48,48.0,48.0,"Inventar/images/gun.png",0.0,0.0,0.0,tocolor(255,255,255,255),true)
				...
				if(slotid) then
					...
					if(itemname and itemname[slotid]) then
							if(	getElementData(getLocalPlayer(),"Item_"..aktuel.."_c") ) then
								id = getElementData(getLocalPlayer(),"Item_"..aktuel.."_c")[i.."_id"]
								if(id) then
									dxDrawImage(item[id]["x"],item[id]["y"],40,40,"Inventar/images/items/"..itemname[slotid]..".png",0.0,0.0,0.0,tocolor(rx,gx,bx,255),itemFront[id])
...
function showInventar(teil)
	...
	pClose,pMove,pReset = "Inventar/images/closeinv.png","Inventar/images/moveinv.png","Inventar/images/reset.png"
...
function onButtonInvEnter()
	...
	elseif( source == btn_Close) then
		pClose = "Inventar/images/closeinvS.png"
	elseif( source == btn_Move) then
		pMove = "Inventar/images/moveinvS.png"
	elseif( source == btn_Reset) then
		pReset = "Inventar/images/resetS.png"
	end
end
...
function onButtonInvLeave()
	...
	elseif( source == btn_Close) then
		pClose = "Inventar/images/closeinv.png"
	elseif( source == btn_Move) then
		pMove = "Inventar/images/moveinv.png"
	elseif( source == btn_Reset) then
		pReset = "Inventar/images/reset.png"
	end
